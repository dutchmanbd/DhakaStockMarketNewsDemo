...
@AndroidEntryPoint
class LastSevenDaysFragment : BaseFragment<LastSevenDaysFragmentBinding>(
    R.layout.last_seven_days_fragment
) {
    @Inject
    lateinit var newsAdapter: NewsAdapter

    override fun initializeViewBinding(view: View) = LastSevenDaysFragmentBinding.bind(view)
