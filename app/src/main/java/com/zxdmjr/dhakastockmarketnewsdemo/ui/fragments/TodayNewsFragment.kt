...
import com.zxdmjr.dhakastockmarketnewsdemo.databinding.TodayNewsFragmentBinding
...
@AndroidEntryPoint
class TodayNewsFragment : BaseFragment<TodayNewsFragmentBinding>(
    R.layout.today_news_fragment
) {

    @Inject
    lateinit var newsAdapter: NewsAdapter

    override fun initializeViewBinding(view: View) = TodayNewsFragmentBinding.bind(view)
